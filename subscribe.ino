...
#define MQTT_CLIENT_NAME "zpjhAhxrOv" // MQTT client Name, please enter your own 8-12 alphanumeric character ASCII string; 
                                           //it should be a random and unique ascii string and different from all other devices
#define VARIABLE_LABEL "soil-sensor" // Assing the variable label
#define VARIABLE_LABEL_SUBSCRIBE "relay" // Assing the variable label
#define DEVICE_LABEL "esp32" // Assig the device label

#define RELAY 23 // Set the GPIO16 as RELAY
